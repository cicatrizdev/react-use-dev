		...
		<div className='min-h-screen px-4 md:px-8 lg:px-16 py-8 pb-32'>
			...
			<div className='max-w-6xl mx-auto mb-16'>
				...
				<div className='max-w-xl mx-auto'>
					<SearchInput placeholder='Buscar produtos...' onSearch={setSearchTerm} />
				</div>
			</div>
					...
					{categories.map((category) => (
						<div
							...
							className={`group cursor-pointer transform transition-transform hover:scale-105 ${
								selectedCategory === category.id ? 'ring-4 ring-[#0B254B] rounded-lg' : ''
							}`}
			...
			<div className='max-w-6xl mx-auto'>
				...
				{filteredProducts.length === 0 ? (
					<div className='flex flex-col items-center justify-center py-16 px-4 text-center'>
						<p className='text-2xl font-bold text-[#0B254B] mb-4'>Nenhum produto encontrado</p>
